...
class DeserializerTest extends TestCase
{
    ...
    public function testLazyDeserialization(): void
    {
        ...
        $process = $deserializer->deserialize('{"s":[{"v":{"s:a":"o:object_id"},"s":[],"r":null,"p":null}],"c":0,"l":1,"ic":{"i":[{"o":1,"a":{"i:0":"i:1"},"t":{"l":1,"p":10}},{"o":4,"a":{"i:0":"s:a"},"t":{"l":1,"p":0}}],"p":[]},"i":"i:2"}');

        self::assertInstanceOf(Process::class, $process);

        self::expectExceptionMessage('Object not found: object_id');
        $process->scopes[0]->variables['a']->test();
    }
}
